...
//       const response = await fetch(process.env.NEXT_PUBLIC_ACCU_URL + 'locations/v1/cities/search?' + new URLSearchParams({
...
//     <div>
//       {loading && !data &&
//         <p>Carregando condições do tempo...</p>
//       }

//       {data && data.map((item, index) => (
//         <p key={index}>{item.LocalizedName}</p>
//       ))}
//     </div>
//   )
// }
